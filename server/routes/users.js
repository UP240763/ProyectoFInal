...
// POST /users — cualquiera puede registrarse
...
// GET /users/filter — solo admin
router.get("/filter", authMiddleware, roleMiddleware("admin"), (req, res) => {
...
// GET /users/:id — admin ve cualquiera, user y dev solo se ven a sí mismos
...
// PUT /users/:id — admin edita cualquiera, user y dev solo se editan a sí mismos
...
// PATCH /users/:id/status — solo admin
router.patch("/:id/status", authMiddleware, roleMiddleware("admin"), (req, res) => {
