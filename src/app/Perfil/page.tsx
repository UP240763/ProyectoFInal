...
export default function TicketsPage() {
    ...
    const inputStyle = { padding: '8px 10px', borderRadius: 6, border: '1px solid #ddd', width: '100%' };
        ...
        <div style={{ padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
                ...
                <button onClick={loadTickets}
                    style={{ padding: '6px 14px', borderRadius: 6, border: '1px solid #0070f3', color: '#0070f3', cursor: 'pointer', background: '#fff' }}>
                    Filtrar
                </button>
            </div>
